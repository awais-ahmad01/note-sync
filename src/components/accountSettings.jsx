...
export default function AccountSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-[#2E2E2E] mb-2">Account Management</h2>
        <p className="text-[#666666]">
          Manage your account preferences and data.
        </p>
      </div>

      <div className="border border-[#D32F2F] rounded-lg bg-[#FFEBEE] p-6">
        <h3 className="text-lg font-semibold text-[#D32F2F] mb-2">Danger Zone</h3>
        ...
        {!showDeleteConfirm ? (
          <button
            onClick={() => setShowDeleteConfirm(true)}
            className="px-6 py-3 cursor-pointer bg-[#D32F2F] text-white rounded-lg shadow-sm hover:bg-[#B71C1C] focus:outline-none focus:ring-2 focus:ring-[#D32F2F] focus:ring-offset-2 focus:ring-offset-white transition-colors"
          >
            Delete Account
          </button>
        ) : (
          <div className="space-y-4">
            ...
            <input
              ...
              value={deleteConfirm}
              onChange={(e) => setDeleteConfirm(e.target.value)}
              className="w-full max-w-xs px-4 py-3 bg-white border border-[#D32F2F] rounded-lg text-[#2E2E2E] placeholder-[#999999] focus:outline-none focus:ring-2 focus:ring-[#D32F2F] focus:border-[#D32F2F] transition-colors"
              placeholder="DELETE"
            />
            <div className="flex gap-3">
              <button
                onClick={handleDeleteAccount}
                disabled={deleting}
                className="px-6 py-3 cursor-pointer bg-[#D32F2F] text-white rounded-lg shadow-sm hover:bg-[#B71C1C] focus:outline-none focus:ring-2 focus:ring-[#D32F2F] focus:ring-offset-2 focus:ring-offset-white disabled:opacity-50 transition-colors"
              >
                {deleting ? (
                  <div className="flex items-center gap-2">
                    <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
              ...
              <button
                ...
                className="px-6 py-3 cursor-pointer bg-[#999999] text-white rounded-lg shadow-sm hover:bg-[#666666] focus:outline-none focus:ring-2 focus:ring-[#999999] focus:ring-offset-2 focus:ring-offset-white transition-colors"
              >
                Cancel
              </button>
            </div>
