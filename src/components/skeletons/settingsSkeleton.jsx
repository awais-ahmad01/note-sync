...
export const SettingsPageSkeleton = () => {
  return (
    <main className="flex-1 overflow-y-auto min-h-screen bg-white">
      <div className="max-w-7xl mx-auto p-8">
        <div className="bg-[#F5F5F5] rounded-xl border border-[#E0E0E0] overflow-hidden animate-pulse">
          <div className="px-6 py-4 border-b border-[#E0E0E0]">
            <div className="h-8 bg-[#E0E0E0] rounded w-64 mb-2"></div>
            <div className="h-4 bg-[#E0E0E0] rounded w-96"></div>
          </div>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-64 bg-white border-r border-[#E0E0E0]">
              <nav className="p-4 space-y-2">
                {[1, 2, 3].map((item) => (
                  <div key={item} className="w-full flex items-center px-3 py-3 rounded-lg bg-[#E0E0E0]">
                    <div className="w-6 h-6 bg-[#D0D0D0] rounded-full mr-3"></div>
                    <div className="h-4 bg-[#D0D0D0] rounded w-20"></div>
                  </div>
                ))}
              </nav>
            </div>
...
export const ProfileSettingsSkeleton = () => {
  return (
    <div className="space-y-6">
      <div>
        <div className="h-7 bg-[#E0E0E0] rounded w-64 mb-2"></div>
        <div className="h-4 bg-[#E0E0E0] rounded w-96"></div>
      </div>

      <div className="flex items-center space-x-6">
        <div className="w-24 h-24 bg-[#E0E0E0] rounded-full"></div>
        <div className="flex-1 space-y-3">
          <div className="flex gap-3">
            <div className="h-10 bg-[#E0E0E0] rounded w-32"></div>
            <div className="h-10 bg-[#E0E0E0] rounded w-24"></div>
          </div>
      ...
      <div>
        <div className="h-4 bg-[#E0E0E0] rounded w-20 mb-2"></div>
        <div className="h-12 bg-[#E0E0E0] rounded w-full"></div>
      </div>

      <div>
        <div className="h-4 bg-[#E0E0E0] rounded w-24 mb-2"></div>
        <div className="h-12 bg-[#E0E0E0] rounded w-full"></div>
        <div className="h-3 bg-[#E0E0E0] rounded w-64 mt-2"></div>
      </div>

      <div className="flex justify-end pt-4">
        <div className="h-12 bg-[#E0E0E0] rounded w-32"></div>
      </div>
    </div>
  );
};