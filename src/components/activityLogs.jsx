...
//             <div 
//               key={log.id} 
//               className="bg-[#F5F5F5] rounded-xl p-6 border border-[#E0E0E0] hover:border-[#D0D0D0] transition-colors"
//             >
//               <div className="flex items-start gap-4">
//                 <div className="flex-shrink-0 w-10 h-10 bg-[#B22222]/20 rounded-full flex items-center justify-center">
//                   {getActionIcon(log.action)}
//                 </div>
